...
import br.com.munhosdev.orderms.domain.OrderItem;
import br.com.munhosdev.orderms.listener.dto.OrderCreatedEvent;
import br.com.munhosdev.orderms.repository.OrderRepository;
...
public class OrderService {
    ...
    public Page<OrderResponse> findAllByCustomerId(Long customerId, PageRequest pageable) {
        ...
        var orders = repository.findAllByCustomerId(customerId, pageable);
